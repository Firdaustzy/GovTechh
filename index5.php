...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <img class="" src="img/banner.png" style="width:100%; height:auto; max-width:400px;">
                </div>
                <div class="col-sm-6">
                    <img class="" src="img/mygplogo.png" style="width:100%; height:auto; max-width:150px; margin-left: 550px;"> 
                </div>
            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="narrow-w form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
                                        <div class="modal-body">
                                            <input type="text" name="search_jabatan" required class="form-control" placeholder="Search data">
                                            <br>
    ...
    <div class="col-md-12">
        ...
        ?>
                    <table class="table table-borderless">
                            ...
                            <?php if($muatnaik == ''){ ?>
                            <tr>
                                <th scope="row"><a href="./error.php"><?php echo $namagarispanduan ?></a></th>
                            </tr>
                            <?php }else{ ?>
                            <tr>
                                <th scope="row"><a href="./dashboard/uploadngp/<?php echo $muatnaik; ?>"><?php echo $namagarispanduan ?></a></th>
                            </tr>
                            <?php  } ?>
                            <tr>
                                <th scope="row"><?php echo $keteranganobjektif ?></th>
                            </tr>
                                <tr>  <th scope="row"><?php echo $namakementerian ?></th></tr>
