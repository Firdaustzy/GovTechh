                        ...
                        <form method="POST" action="forminsert.php" enctype="multipart/form-data">
                            ...
                            <div class="col">
                                <div class="multiselect">
                                    ...
                                    <div id="checkboxes">
                                        <label for="one"> &nbsp;
                                            <input type="checkbox" name="cbox[]" value="PEMBUATAN" /> &nbsp;PEMBUATAN</label>
                                        <label for="two"> &nbsp;
                                            <input type="checkbox" name="cbox[]" value="PERKHIDMATAN" /> &nbsp;PERKHIDMATAN</label>
                                        <label for="three"> &nbsp;
                                            <input type="checkbox" name="cbox[]" value="PEMBINAAN" /> &nbsp;PEMBINAAN</label>
                                        <label for="four"> &nbsp;
                                            <input type="checkbox" name="cbox[]" value="PERLOMBONGAN" /> &nbsp;PERLOMBONGAN</label>
                                        <label for="five"> &nbsp;
                                            <input type="checkbox" name="cbox[]" value="PERTANIAN" /> &nbsp;PERTANIAN</label>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col">
                                <label for="">Sektor : &nbsp;</label>
                                <input type="checkbox" name="cbox[]" value="PEMBUATAN" class="theClass" />PEMBUATAN &nbsp;

                                <input type="checkbox" name="cbox[]" value="PERKHIDMATAN" class="theClass" />PERKHIDMATAN &nbsp;
                                <input type="checkbox" name="cbox[]" value="PEMBINAAN" class="theClass" />PEMBINAAN &nbsp;
                                <input type="checkbox" name="cbox[]" value="PERLOMBONGAN" class="theClass" />PERLOMBONGAN &nbsp;
                                <input type="checkbox" name="cbox[]" value="PERTANIAN" class="theClass" />PERTANIAN
                                ...
                                <!-- <div class="col">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="techno[]" id="customCheck1" value="PEMBUATAN">
                                        <label class="custom-control-label" for="customCheck1">PEMBUATAN</label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="techno[]" id="customCheck2" value="PERKHIDMATAN">
                                        <label class="custom-control-label" for="customCheck2">PERKHIDMATAN</label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="techno[]" id="customCheck3" value="PEMBINAAN">
                                        <label class="custom-control-label" for="customCheck3">PEMBINAAN</label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="techno[]" id="customCheck4" value="PERLOMBONGAN">
                                        <label class="custom-control-label" for="customCheck4">PERLOMBONGAN</label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="techno[]" id="customCheck5" value="PERTANIAN">
                            ...
                            <!-- <div class="multiselect">
                                    ...
                                    <div class="selectBox" onclick="showCheckboxes()">
                                        <select>
                                            <option>Pilih Liputan</option>
                                        </select>
                                        <div class="overSelect"></div>
                                    </div>
                                    <div id="checkboxes">
                                        <label for="one"> &nbsp;
                                            <input type="checkbox" id="one" value="PAHANG"/>  &nbsp;First checkbox</label>
                                        <label for="two"> &nbsp;
                                            <input type="checkbox" id="two" value="PERAK" /> &nbsp;Second checkbox</label>
                                        <label for="three"> &nbsp;
                                            <input type="checkbox" id="three" value="TERENGGANU" /> &nbsp;Third checkbox</label>
                                            <label for="three"> &nbsp;
                                            <input type="checkbox" id="three" value="PERLIS" /> &nbsp;Third checkbox</label>
                                            <label for="three"> &nbsp;
                                            <input type="checkbox" id="three" value=SELANGOR" /> &nbsp;Third checkbox</label>
                                            <label for="three"> &nbsp;
                                            <input type="checkbox" id="three" value="NEGERI SEMBILAN" /> &nbsp;NEGERI SEMBILAN</label>
                                            <label for="JOHOR"> &nbsp;
                                            <input type="checkbox" id="JOHOR" value="JOHOR" /> &nbsp;JOHOR</label>
                                            <label for="KELANTAN"> &nbsp;
                                            <input type="checkbox" id="KELANTAN" value="KELANTAN" /> &nbsp;KELANTAN</label>
                                            <label for="KEDAH"> &nbsp;
                                            <input type="checkbox" id="KEDAH" value="KEDAH" /> &nbsp;KEDAH</label>
                                            <label for="PULAU PINANG"> &nbsp;
                                            <input type="checkbox" id="PULAU PINANG" value="PULAU PINANG" /> &nbsp;PULAU PINANG</label>
                                            <label for="MELAKA"> &nbsp;
                                            <input type="checkbox" id="MELAKA" value="MELAKA" /> &nbsp;MELAKA</label>
                                            <label for="KUALA LUMPUR"> &nbsp;
                                            <input type="checkbox" id="KUALA LUMPUR" value="KUALA LUMPUR" /> &nbsp;KUALA LUMPUR</label>
                                            <label for="SABAH"> &nbsp;
                                            <input type="checkbox" id="SABAH" value="SABAH" /> &nbsp;SABAH</label>
                                            <label for="SARAWAK"> &nbsp;
                                            <input type="checkbox" id="SARAWAK" value="SARAWAK" /> &nbsp;SARAWAK</label>
                                            <label for="SELURUH MALAYSIA"> &nbsp;
                                            <input type="checkbox" id="SELURUH MALAYSIA" value="SELURUH MALAYSIA" /> &nbsp;SELURUH MALAYSIA</label>
                                            <label for="BORNEO(SABAH & SARAWAK)"> &nbsp;
                                            <input type="checkbox" id="BORNEO(SABAH & SARAWAK)" value="BORNEO(SABAH & SARAWAK)" /> &nbsp;SABAH</label>
                                    </div>
                                </div> -->
                            <!-- <div class="row d-flex justify-content mt-100">
                                    <label for="sektors[]">Sektor<span class="required">*</span></label>
                                    <br>
                                    <div class="col-md-12">
                                        <select id="choices-multiple-remove-button" name="sektors[]" placeholder="Sila Pilih Sektor" multiple required>
